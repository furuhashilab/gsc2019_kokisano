...
　本研究では、ドローンが人々にもたらす数々の恩恵を紹介しながら「一般の人々にとってより身近なものにするにはどうしたら良いか」ということをベースとしてドローンと街中に存在する人命救助装置の代表例「AED」との融合方法を見出し、その上でどのようにすればそれを「一般の人自身」によって操作することを可能とするかあるいは操縦そのものをドローン自体が行うということを提案している。
